...
% 2) If there are patterns, use a specific search called "cheap_edges_first".
...
% 3) Try to eliminate edges my decreasing cost: it will eliminate the more expensive edges first, until
