...
correspond to the ones added to connect Classes od the ontology that never 
...
\begin{tikzpicture}
	...
	\node[class] (pe1) at (3,0)  {\small Person};
	\node[class] (co1) at (6,0) {\small Org.};
	\node[class] (ci1) at (1,0) {\small City};
...
\def\ysh{-2.5};
	...
	\node[class] (pl2) at (-1,0+\ysh)  {\small City};
	\node[class] (pe2) at (3,0+\ysh)  {\small Person};
	\node[class] (co2) at (1,0+\ysh) {\small Org.};
	\node[class] (ev2) at (6,0+\ysh) {\small Event};
	
	\node[data] (pen) at (2.5,-1+\ysh) {\scriptsize Person.name};
	\node[data] (evs) at (4.2,-1+\ysh) {\scriptsize Event.startDate};
	\node[data] (eve) at (6,-1+\ysh) {\scriptsize Event endDate};
	\node[data] (con) at (1,-1+\ysh) {\scriptsize Org.name};
	\node[data] (pln) at (-1,-1+\ysh) {\scriptsize City.name};
...
\end{tikzpicture}
\caption{Example of alignment graph.}
\label{FIG:ali}
\end{figure}
