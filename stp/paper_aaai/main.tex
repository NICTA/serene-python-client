...
%\begin{itemize}
	%\item 
	a novel modeling framework for the \relonto{} problem that uses ML, KRR and CP techniques;
...
\citeasnoun{Limaye:Annotating} enrich their data sources by using YAGO \cite{suchanek2007yago}.
