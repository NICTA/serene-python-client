...
The semantic model may have several instances of the same ontology class or 
object property.
...
finding the semantic model. \ddg{is this last paragraph true?}
...
This is known as Transactional Frequent Graph Pattern Mining, which generalizes 
...
It is therefore natural to model this a STP with side constraints, since the 
...
match, then both the \emph{unknown} and \emph{root} nodes won't be selected in 
...
recall, and it's precision can be enhanced by adding a scaling factor for 
pattern costs.
