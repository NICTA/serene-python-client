...
Black links are links supported by the known semantic models. 
Blue links are inferred from the ontology.\forijcai{(the orange 
...
We run experiments on two domains: museum (29 sources, 20 labels, 443 attributes and 159 \emph{unknown}s) and soccer (12 sources, 18 labels, 138 attributes and 45 \emph{unknown}s).% (see Fig.~\ref{tab:data} for statistics).
...
\section{Conclusion}
In this paper we have introduced a new approach\forijcai{, \serene{} (and its extension 
