...
%\ddg{Better title than this please...}}
...
(e.g, mean/max/min string length and numeric statistics) and more.
...
In current systems, these columns are removed in a pre-processing step that requires
extra time and effort on the user side.
