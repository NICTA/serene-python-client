...
In Tab.~\ref{tab:nounkn} we show how the systems perform if we manually remove the unmatched attributes.
  ...
  \caption{Performance with unknowns manually removed% for leave one out strategy.
  	...
  	\begin{tabular}{c|cc|cc} 
  		...
  		\multicolumn{2}{c}{Recall}\\
  		 & museum & soccer & museum & soccer\\
  		\hline
  		\karma{} &  0.72 & 0.87 & 0.54 & 0.61 \\
 		\serene{} & 0.82 & 0.86 & 0.62 & 0.75 \\
